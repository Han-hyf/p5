...
public class SimpleJavaClientGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        addSelectByIdsMethod(interfaze);
    ...
    protected void addCountMethod(Interface interfaze) {
    ...
    protected void addListMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateList()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new ListMethodGenerator(true);
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
    ...
    protected void addSelectByIdsMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateSelectByIds()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new SelectByIdsMethodGenerator(true);
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
