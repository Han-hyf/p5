...
public class BaseRecordGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        topLevelClass.addImportedType("com.taoge.framework.annotation.PrimaryKey");
        ...
        for (IntrospectedColumn introspectedColumn : introspectedColumns) {
            ...
            if (primaryKeyColumns.contains(introspectedColumn)) {
                String primaryAnnotation = "@PrimaryKey";
                GeneratedKey generatedKey = introspectedTable.getGeneratedKey();
                System.out.println("primary filed:" + field.getName());
                if (generatedKey != null) {
                    if (generatedKey.getColumn().equals(introspectedColumn.getActualColumnName())) {
                        System.out.println("primary column: " + generatedKey.getColumn() + " - " + introspectedColumn.getActualColumnName());
                        primaryAnnotation = "@PrimaryKey(autoIncrement = true)";
                    }
                }
                field.addAnnotation(primaryAnnotation);
            }
