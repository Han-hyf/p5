...
public class TableConfiguration extends PropertyHolder {
    ...
    private boolean listStatementEnabled;

    private boolean selectByIdsStatementEnabled;
    ...
    public TableConfiguration(Context context) {
        ...
        listStatementEnabled = true;
        selectByIdsStatementEnabled = true;
        keyProperty = "";
    }
    ...
    public boolean isListStatementEnabled() {
        return listStatementEnabled;
    }
    public boolean isSelectByIdsStatementEnabled() {
        return selectByIdsStatementEnabled;
    }
    ...
    public boolean areAnyStatementsEnabled() {
        return selectByExampleStatementEnabled
                ...
                || listStatementEnabled
                || selectByIdsStatementEnabled;
    }
    ...
    public XmlElement toXmlElement() {
        ...
        if (stringHasValue(keyProperty)) {
            xmlElement.addAttribute(new Attribute("keyProperty", keyProperty)); //$NON-NLS-1$
        }
        ...
        if (!listStatementEnabled) {
            xmlElement.addAttribute(new Attribute(
                    "list", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }

        if (!selectByIdsStatementEnabled) {
            xmlElement.addAttribute(new Attribute(
                    "selectByIds", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }
