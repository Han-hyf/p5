...
public abstract class IntrospectedTable {
    ...
    protected List<IntrospectedColumn> listColumns;
    ...
    public String getListType() {
        return internalAttributes.get(InternalAttribute.ATTR_LIST_TYPE);
    }
    ...
    protected void calculateXmlAttributes() {
        ...
        setSelectByIdsStatementId("selectByIds"); //$NON-NLS-1$
    ...
    public void setListStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_LIST_STATEMENT_ID, s);
    }
    ...
    public void setCount(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_COUNT, s);
    }
    ...
    public String getListStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_LIST_STATEMENT_ID);
    }
    ...
    public String getCount() {
        return internalAttributes
                .get(InternalAttribute.ATTR_COUNT);
    }
    ...
    protected void calculateJavaClientAttributes() {
        ...
        sb.append("MapperImpl"); //$NON-NLS-1$
    ...
    public void setListType(String listType) {
        internalAttributes.put(InternalAttribute.ATTR_LIST_TYPE,
                listType);
    }
