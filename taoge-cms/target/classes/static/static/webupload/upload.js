    ...
    $(function() {
        ...
        function addFile( file ) {
            var $li = $( '<li id="' + file.id + '"><div class="item">' +
                ...
                '<p class="imgWrap"><a class="image-popup-gallery-item" href="https://ks3-cn-beijing.ksyun.com/yq-live-test/yunqintest/ff672d25-3dd5-4bad-a731-0b157e67f4d6.png"></a></p>'+
                ...
                $wrap = $li.find( 'a.image-popup-gallery-item' ),
            ...
            file.on('statuschange', function( cur, prev ) {
                ...
                if ( cur === 'error' || cur === 'invalid' ) {
                    ...
                    // console.log($li.find("image").attr("src"));
                    // $li.find("a.image-popup-gallery-item").attr(
